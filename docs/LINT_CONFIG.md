...
Consequência prática de a contagem de errors estar zerada: enquanto o hook rodar com `--blocking error`, ele não barra nada (ver o aviso na seção do gate, acima). É o que motiva pagar os warnings restantes e migrar o gate para `--blocking warning`.
