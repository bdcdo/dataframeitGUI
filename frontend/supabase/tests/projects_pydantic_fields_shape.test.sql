...
BEGIN
  FOR bad IN SELECT * FROM (VALUES
    ...
    ('id com sobra antes',
     '[{"id":"x00000000-0000-4000-8000-0000000000d1","name":"a"}]'::JSONB),
    ('id com sobra depois',
     '[{"id":"00000000-0000-4000-8000-0000000000d1x","name":"a"}]'::JSONB),
    ('nome que nao e texto',
     '[{"id":"00000000-0000-4000-8000-0000000000d1","name":1}]'::JSONB),
    ('id repetido',
