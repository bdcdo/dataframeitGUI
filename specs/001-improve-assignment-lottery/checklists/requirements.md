...
- 2026-06-11 (pós-/speckit-analyze): remediados os 5 achados da análise — FR-013/SC-005 reconciliados com FR-019 (igualdade prévia ≡ sorteio garantida a partir da prévia, com configuração e dados inalterados; mecanismo de semente em research D13); FR-018 qualificado pelo modo corrente (substituir não conta pendentes descartadas); SC-007 reduzido à formulação operacional; edge case de dados mudados entre prévia e sorteio; "rodada" registrado como sinônimo de UI do termo canônico "lote". Revalidação: todos os itens seguem passando.
